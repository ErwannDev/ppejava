    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (source == vue.getjButtonConnection()) {
            ...
            try {
                ...
                Logger.getLogger(ControllerAccueil.class.getName()).log(Level.SEVERE, "SQL Exeption", ex);
            } catch (ClassNotFoundException ex) {
                Logger.getLogger(ControllerAccueil.class.getName()).log(Level.SEVERE, "Class Not Found Exeption", ex);
            }
